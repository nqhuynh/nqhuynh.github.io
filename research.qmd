...
[<a href="papers/Huynh_Nghiem_JMP.pdf" target="_blank">PDF (July 2025)</a> | <a href="https://papers.ssrn.com/sol3/papers.cfm?abstract_id=5281304" target="_blank">SSRN</a> | <span id="abs-btn1" onclick="toggleAbstract('abstract1')" style="color: #841617; cursor: pointer;">Abstract ˅</span> | <span id="cite-btn1" onclick="toggleCitation('citation1')" style="color: #841617; cursor: pointer;">Citation ˅</span>]
...
<span id="cite-btn2" onclick="toggleCitation('citation2')" style="color: #841617; cursor: pointer;">Citation ˅</span>]
:::
